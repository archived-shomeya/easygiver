...
function _rootcandy_admin_navigation() {
  ...
  elseif ($rootcandy_navigation == '_rootcandy_default_navigation') {
    ...
    if (user_access('administer store') && module_exists('uc_store')) {
      $menu_tree[] = array('href' => 'admin/store', 'title' => 'Store');
    }
    if (user_access('view code review') && module_exists('coder')) {
      $menu_tree[] = array('href' => 'coder', 'title' => 'Code review');
    }
