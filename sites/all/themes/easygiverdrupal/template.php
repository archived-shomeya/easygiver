 ...
 */
function easygiverdrupal_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function easygiverdrupal_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function easygiverdrupal_button($element) {
...
*/
function easygiverdrupal_img_assist_page($content, $attributes = NULL) {
